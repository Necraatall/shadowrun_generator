...
hair_color = ['auburn', 'brown', 'black', 'blonde', 'copper', 'ginger', 'golden', 'grey', 'mouse', 'red', 'dark brown',
              'white']
skin_tone = ['almond', 'brown', 'bronze', 'chocolate', 'cocoa', 'dark chocolate', 'fair', 'light', 'olive', 'pale',
             'olive', 'walnut']

rase_choice = ['Caucasian', 'Latino/Hispanic', 'African', 'Caribbean', 'Middle Eastern', 'South Asian', 'East Asian',
               'Mixed']
